...
})({"kIJe8":[function(require,module,exports) {
...
async function getWeather(lat, long) {
    try {
        const weatherData = await (0, _axiosDefault.default)(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&units=metric&appid=4810a4405a029b3e087478da7c24eba9`);
        //returnera vädret 
...
async function getLocationName(lat, long) {
    try {
        const response = await (0, _axiosDefault.default)(`http://api.openweathermap.org/geo/1.0/reverse?lat=${lat}&lon=${long}&appid=4810a4405a029b3e087478da7c24eba9`);
...
async function kanyeQuotes() {
    ...
    try {
        const quoteData = await (0, _axiosDefault.default)("https://api.kanye.rest");
...
async function boredActivities() {
    ...
    try {
        const response = await (0, _axiosDefault.default)("https://www.boredapi.com/api/activity");
...
var Buffer = require("695153b817bf2281").Buffer;
"use strict";
/**
...
},{"695153b817bf2281":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../env/classes/FormData.js":"lSnyf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("9dce98aa5a9d485b");
var ieee754 = require("f8a21fe64ceb0e72");
...
},{"9dce98aa5a9d485b":"eIiSV","f8a21fe64ceb0e72":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kIJe8","jUTag"], "jUTag", "parcelRequiref2cc")
